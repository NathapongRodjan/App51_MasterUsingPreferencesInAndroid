...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fontNumber1 = Typeface.createFromAsset(getAssets(), "fonts/FREESCPT.TTF");
        fontNumber2 = Typeface.createFromAsset(getAssets(), "fonts/Gabriola.ttf");
        fontNumber3 = Typeface.createFromAsset(getAssets(), "fonts/LCALLIG.TTF");
